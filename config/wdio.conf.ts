...
export const config: Options.Testrunner = {
    ...
    onPrepare: function (config, capabilities) {
        helper.deleteDirectory('allure-results');
        helper.deleteDirectory('allure-report');
        helper.deleteDirectory('cucumber-json-reports');
        // helper.deleteDirectory('_results_');
    },
    /**
